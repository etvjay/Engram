  ...
  return (
    <main className="shell">
      <header className="topbar">
        <div>
          <div className="brand"><a href="/" style={{color:"inherit",textDecoration:"none"}}>ENGRAM</a></div>
          <div className="brand-sub">Execution Memory · <a href="/" style={{color:"inherit"}}>Landing</a></div>
        </div>
